...
From the left menu select Instance Groups then Add.  Fill out the Name as you have been for the earlier labs, the Display Name can be anything you want, as is the description (feel free to modify these).
